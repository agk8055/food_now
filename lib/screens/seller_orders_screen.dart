...
class _SellerOrdersScreenState extends State<SellerOrdersScreen> {
  ...
  void _showVerifyOTPDialog(BuildContext context, String orderId, String correctOtp, String buyerName) {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              title: const Text("Verify Pickup", style: TextStyle(fontWeight: FontWeight.bold)),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text("Enter the 4-digit code from $buyerName's app to complete this order.", style: TextStyle(color: Colors.grey[700])),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "0000",
                      counterText: "",
                      errorText: isError ? "Incorrect OTP. Please try again." : null,
    ...
    return FutureBuilder<DocumentSnapshot?>(
      ...
      builder: (context, shopSnapshot) {
        if (shopSnapshot.connectionState == ConnectionState.waiting) {
          return const Scaffold(body: Center(child: CircularProgressIndicator(color: Color(0xFF00bf63))));
        }
        ...
        return DefaultTabController(
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, orderSnapshot) {
              if (orderSnapshot.hasError) return Scaffold(body: Center(child: Text('Error: ${orderSnapshot.error}')));
              ...
              return Scaffold(
                ...
                appBar: AppBar(
                  title: const Text("Orders & Pickups", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800)),
  ...
  Widget _buildOrderList(List<QueryDocumentSnapshot> orders, {required bool isPendingTab}) {
    if (orders.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(
              isPendingTab ? Icons.assignment_turned_in_outlined : Icons.history,
              size: 80,
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: const Icon(Icons.person, color: Color(0xFF00bf63)),
                      ),
            ...
            child: Column(
              ...
              children: items.map((item) {
                return Padding(
                  ...
                  child: Row(
                    children: [
                      Text("${item['cartQuantity']}x", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      const SizedBox(width: 8),
                      Expanded(child: Text(item['name'], style: TextStyle(color: Colors.grey[800], fontSize: 14))),
                    ],
                  ),
                );
              }).toList(),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                if (status == 'pending')
                  ElevatedButton.icon(
                    onPressed: () => _showVerifyOTPDialog(context, orderId, otp, buyerName),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF00bf63),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                      elevation: 0,
                    ...
                    label: const Text("VERIFY OTP", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
                  ),
              ],
            ),
          ),
