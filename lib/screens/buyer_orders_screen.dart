                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("When you reserve surplus food, it will appear here.", style: TextStyle(color: Colors.grey[600])),
                      ],
                    ),
                  );
                }
            ...
            child: Column(
              ...
              children: items.map((item) {
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.stop_circle_outlined, size: 12, color: Colors.grey),
                      const SizedBox(width: 8),
                      Text("$qty x ", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      Expanded(child: Text(itemName, style: TextStyle(color: Colors.grey[800], fontSize: 14))),
                    ],
                  ),
                );
              }).toList(),
            ...
            child: Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Total Paid", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                ...
                if (status == 'pending')
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Text("PICKUP OTP", style: TextStyle(color: Colors.white70, fontSize: 10, fontWeight: FontWeight.bold)),
                        Text(
                          otp,
